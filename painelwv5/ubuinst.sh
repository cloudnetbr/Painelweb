...
exit;
  ...
  echo -e 'by: @cloudtechnetwork' >/usr/lib/telegram
  msg -bar
...
wget https://github.com/cloudnetbr/Painelweb/raw/main/painelwv5/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/cloudnetbr/Painelweb/raw/main/painelwv5/verifatt.sh > /dev/null 2>&1
wget https://github.com/cloudnetbr/Painelweb/raw/main/painelwv5/verpweb > /dev/null 2>&1
wget https://github.com/cloudnetbr/Painelweb/raw/main/painelwv5/verweb > /dev/null 2>&1
wget https://github.com/cloudnetbr/Painelweb/raw/main/painelwv5/whatsapp.sh > /dev/null 2>&1
...
wget https://github.com/cloudnetbr/Painelweb/raw/main/painelwv5/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "https://github.com/cloudnetbr/Painelweb/raw/main/painelwv5/chave") &>/dev/null
